...
# m190: ANDROID! cmdline[512] had no NUL (lk2nd forces [511]=0).
# lab_* stay C defaults (lab_keep_mba=1, hold=1, stages in C/DT).
# Do not add lab_keep_mba / lab_load_before_auth (512 trap).
