/*
 * talkman-vk-clear32 — 32-bit GPU-write proof for Lumia 950 (MSM8992 / Adreno 418).
 *
 ...
 * Same as talkman-vk-clear, compile_multilib 32. No WSI, no HWUI, no software clear.
 */
...
int main(void) {
    ...
    talkman_log("talkman-vk-clear32 start (Vulkan 1.0) ptr=%zu", sizeof(void*));

    memset(&app, 0, sizeof(app));
    app.sType = VK_STRUCTURE_TYPE_APPLICATION_INFO;
    app.pApplicationName = "talkman-vk-clear32";
    app.applicationVersion = 1;
    app.pEngineName = "talkman-vk-clear32";
    app.engineVersion = 1;
    ...
    if (n == 0) {
        talkman_err("talkman-vk-clear32: vkEnumeratePhysicalDevices returned 0");
    ...
    free(gpus);
    vkDestroyInstance(inst, NULL);
    talkman_log("talkman-vk-clear32 done rc=%d", rc);
    return rc;
}
